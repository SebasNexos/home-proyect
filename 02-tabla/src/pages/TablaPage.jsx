...
import {
  ...
  TableRow, TableCell, Input, Button,
...
import { columns, statusOptions } from "../helpers/columns";
...
const INITIAL_VISIBLE_COLUMNS = ["nombre", "apellido", "experiencia", "email", "estado"];
